...
#define STRING_CONFIG_H_AUTHOR "setar@3nt.ru" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "3ntProf 10.0.Y" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "trinitygroup.ru"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "3ntProf"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "5777a60b-88ed-4102-babe-970ba40c4704"
...
#define SWITCHING_EXTRUDER
  ...
  #define SWITCHING_EXTRUDER_SERVO_ANGLES { 27, 144 } // Angles for E0, E1[, E2, E3]
  #if EXTRUDERS > 3
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 16.422602
  #define DEFAULT_Ki 1.070016
  #define DEFAULT_Kd 63.013519
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 165.011887
  #define DEFAULT_bedKi 16.503664
  #define DEFAULT_bedKd 412.467834
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 106.6667, 106.6667, 1920, 280 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.70 // (больше минус - сильнее вдавливаем в стекло)Z offset: -below +above  [the nozzle]
